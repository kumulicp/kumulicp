    ...
    */
    ...
    'notification' => [
        ...
        'bill' => [
            ...
            'line_2' => 'If you would like to cancel your subscription, login at',
            'line_3' => 'If you don\'t have access, any of these admins are able to do this',
        ],
        'invoice' => [
            'line_1' => 'Attached is your invoice for',
            'line_2' => 'If you weren\'t expecting this place login and submit an inquiry',
            'line_3' => 'Or check with other admins',
        ],
        ...
        'permissions_updated' => [
            'message' => 'You\'re permissions have been updated.',
            'app_access_title' => 'Application Access',
            'access_granted' => 'You have been given access to :app',
            'basic_access_granted' => 'You have been given :role access to :app',
            'access_revoked' => 'Your access to :app has been revoked',
            'permissions_granted_title' => 'Permissions Granted',
            'permissions_granted' => 'You have been granted :role permission in :app',
            'permissions_modified_title' => 'Permissions Modified',
            'permissions_modified' => 'Your permissions have changed to :role in :app',
            'permissions_removed_title' => 'Permissions Removed',
    ...
    'api' => [
        'nextcloud' => [
            'team_folders' => [
                ...
                'quota_reached' => [
                    'low_1' => 'One of your team folders is low on storage space!',
                    'low_2' => 'Some of your team folders are low on storage space!',
                    'current' => 'Current Usuage:',
                    'limit' => 'Storage Limit:',
                    'percent_used' => 'Percent Used:',
                    'remaining' => 'Storage Left:',
                    'manage_groups' => 'Manage Groups:',
                    'go_to_nextcloud' => 'Go to Nextcloud:',
                ],
            ],
            'users' => [
