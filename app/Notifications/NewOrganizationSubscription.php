...
class NewOrganizationSubscription extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toPanel($notifiable)
    {
        ...
        return [
            'title' => __('messages.notification.organization.subscribed', ['organization' => $organization->name]),
