...
class NextcloudProfile extends AppProfile
{
    ...
    protected $configurations = [
        ...
        'preview-max-filesize-image' => [
            'name' => 'preview-max-filesize-image',
            'type' => 'int',
            'default' => 50,
            'persistent' => false,
            'validations' => 'nullable|integer',
        ...
        'preview-max-memory' => [
            'name' => 'preview-max-memory',
            'type' => 'int',
            'default' => 256,
            'persistent' => false,
            'validations' => 'nullable|integer',
        ],
        'preview-concurrency-new' => [
            'name' => 'preview-concurrency-new',
            'type' => 'int',
            'default' => 4,
            'persistent' => false,
            'validations' => 'nullable|integer',
        ],
        'preview-concurrency-all' => [
            'name' => 'preview-concurrency-all',
            'type' => 'int',
            'default' => 8,
            'persistent' => false,
            'validations' => 'nullable|integer',
