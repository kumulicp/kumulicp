    ...
    public function updateSettings()
    {
        ...
        $this->run(
            ...
            env: [
                ...
                ['name' => 'OIDC_CLIENT_ID', 'value' => $app_instance->configuration('enable-sso') && $app_instance->setting('sso_client_id') ? Crypt::decryptString($app_instance->setting('sso_client_id')) : ''],
                ['name' => 'OIDC_CLIENT_SECRET', 'value' => $app_instance->configuration('enable-sso') && $app_instance->setting('sso_client_secret') ? Crypt::decryptString($app_instance->setting('sso_client_secret')) : ''],
